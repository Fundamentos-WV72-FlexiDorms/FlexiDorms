package com.techartistry.paymentsservice.config;
...
public class KafkaConsumerConfig {
     ...
     */
    @Bean
    public ConsumerFactory<String, BookingCreatedEvent> accountConsumerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, BookingCreatedEvent> accountKafkaListenerFactory() {
